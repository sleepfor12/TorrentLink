...
QString UiTheme::mainWindowStyleSheet(EffectiveUiTheme theme) {
  if (theme == EffectiveUiTheme::Dark) {
    return QStringLiteral(
               ...
               "QPushButton{background:#1e3a5f;color:#e2e8f0;border:1px solid "
               "#334155;border-radius:10px;"
               "padding:8px 14px;font-weight:600;font-size:14px;}"
               "QPushButton:hover{background:#2563eb;color:#ffffff;}"
               "QPushButton#PrimaryButton{background:#2563eb;color:#ffffff;border:1px solid "
               "#2563eb;}"
               ...
               "QPushButton#FilterButton:checked{background:#2563eb;color:#ffffff;border:1px solid "
               "#2563eb;}"
               ...
               "QPushButton#FilterMoreButton:checked{background:#334155;color:#e2e8f0;border:1px "
               "solid "
               "#475569;}"
               "QWidget#StatCard{background:#1e293b;border:1px solid #334155;border-radius:12px;}"
               "QWidget#BottomStatusBar{background:#1e293b;border:1px solid "
               "#334155;border-radius:12px;}"
               ...
               "QComboBox{background:#0f172a;color:#e2e8f0;border:1px solid "
               "#475569;border-radius:8px;"
               "padding:4px 8px;font-size:14px;}"
               "QComboBox QAbstractItemView{background:#1e293b;color:#e2e8f0;border:1px solid "
               "#475569;}") +
  ...
  return QStringLiteral(
             ...
             "QPushButton{background:#eef3ff;color:#2b3a55;border:1px solid "
             "#d6e3ff;border-radius:10px;"
             "padding:8px 14px;font-weight:600;font-size:14px;}"
             ...
             "QPushButton#FilterButton:checked{background:#1677ff;color:#ffffff;border:1px solid "
             "#1677ff;}"
             ...
             "QPushButton#FilterMoreButton:checked{background:#e8eefc;color:#1f2937;border:1px "
             "solid "
             "#b6c8ee;}"
             "QWidget#StatCard{background:#ffffff;border:1px solid #e7ebf3;border-radius:12px;}"
             "QWidget#BottomStatusBar{background:#ffffff;border:1px solid "
             "#e7ebf3;border-radius:12px;}"
...
QString UiTheme::auxiliaryDialogStyleSheet(const QString& dialogObjectName,
  ...
  if (theme == EffectiveUiTheme::Dark) {
    ...
    s += sel +
         QStringLiteral(" QGroupBox{border:1px solid #334155;border-radius:10px;margin-top:10px;"
    ...
    s += sel +
         QStringLiteral(" QLabel#DialogTitleLabel{font-size:18px;font-weight:800;color:#f1f5f9;}");
    ...
    s += sel +
         QStringLiteral(" QTreeWidget{background:#0f172a;color:#e2e8f0;border:1px solid #475569;"
                        "border-radius:8px;}");
    ...
    s += sel +
         QStringLiteral(" QPushButton{background:#1e293b;color:#e2e8f0;border:1px solid #475569;"
    ...
    s += sel +
         QStringLiteral(" QDialogButtonBox QPushButton[text=\"确定\"]:hover{background:#3b82f6;}");
    s += sel + QStringLiteral(" QPlainTextEdit,") + sel +
         QStringLiteral(" QTextEdit{background:#0f172a;color:#e2e8f0;border:1px solid #475569;"
                        "border-radius:8px;font-family:monospace;padding:8px;}");
    s += sel +
         QStringLiteral(" QComboBox QAbstractItemView{border:1px solid #475569;background:#1e293b;"
                        "color:#e2e8f0;}");
    return s;
  }
  QString s;
  ...
  s +=
      sel + QStringLiteral(" QGroupBox{border:1px solid #e4e8f0;border-radius:10px;margin-top:10px;"
                           "padding:12px;background:#ffffff;font-weight:600;color:#1f2937;}");
  s += sel + QStringLiteral(" QGroupBox::title{subcontrol-origin:margin;left:12px;padding:0 4px;"
                            "color:#2f3542;}");
  s += sel + QStringLiteral(" QLabel{color:#4c5566;}");
  s += sel +
       QStringLiteral(" QLabel#DialogTitleLabel{font-size:18px;font-weight:800;color:#1f2d3d;}");
  s += sel + QStringLiteral(" QLineEdit,") + sel + QStringLiteral(" QComboBox,") + sel +
       QStringLiteral(" QSpinBox{border:1px solid #d0d7e2;border-radius:8px;background:#ffffff;"
                      "color:#1f2937;padding:4px 8px;}");
  s +=
      sel + QStringLiteral(" QTreeWidget{background:#ffffff;color:#1f2937;border:1px solid #d0d7e2;"
                           "border-radius:8px;}");
  ...
  s += sel + QStringLiteral(" QHeaderView::section{background:#f8fbff;color:#50607a;border:none;"
                            "padding:6px;font-weight:600;}");
  s +=
      sel + QStringLiteral(" QPushButton{background:#ffffff;color:#1f2937;border:1px solid #d0d7e2;"
                           "border-radius:8px;padding:6px 14px;}");
  ...
  s += sel +
       QStringLiteral(" QDialogButtonBox QPushButton[text=\"确定\"]:hover{background:#1760cf;}");
  s += sel + QStringLiteral(" QPlainTextEdit,") + sel +
       QStringLiteral(" QTextEdit{background:#ffffff;color:#1f2937;border:1px solid #d0d7e2;"
                      "border-radius:8px;font-family:monospace;padding:8px;}");
  s += sel +
       QStringLiteral(" QComboBox QAbstractItemView{border:1px solid #d0d7e2;background:#ffffff;"
                      "color:#1f2937;}");
  return s;
}
...
QString UiTheme::detailTabBarStyleSheet(EffectiveUiTheme theme) {
  if (theme == EffectiveUiTheme::Dark) {
    return QStringLiteral(
        ...
        "QPushButton#DetailTabButton:hover{background:#1e293b;color:#cbd5e1;}");
  }
  return QStringLiteral(
