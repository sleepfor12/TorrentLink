...
QString UiTheme::auxiliaryDialogStyleSheet(const QString& dialogObjectName,
  ...
  if (theme == EffectiveUiTheme::Dark) {
    ...
    s += sel +
         QStringLiteral(" QPlainTextEdit{background:#0f172a;color:#e2e8f0;border:1px solid #475569;"
  ...
  s += sel +
       QStringLiteral(" QPlainTextEdit{background:#ffffff;color:#1f2937;border:1px solid #d0d7e2;"
                      "border-radius:8px;font-family:monospace;padding:8px;}");
  s += sel +
