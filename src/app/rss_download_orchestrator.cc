...
void RssDownloadOrchestrator::enqueueMagnet(
    const pfd::app::RssDownloadPipeline::MagnetQueueItem& item,
    const std::atomic<bool>& shuttingDown) {
  pipeline_.enqueueMagnet(
      item, [this, &shuttingDown](pfd::app::RssDownloadPipeline::MagnetQueueItem in) {
...
void RssDownloadOrchestrator::enqueueRssTorrentUrl(
    ...
    const std::atomic<bool>& shuttingDown) {
  pipeline_.enqueueRssTorrentUrl(
      item, [this, &shuttingDown](pfd::app::RssDownloadPipeline::RssTorrentUrlQueueItem in) {
